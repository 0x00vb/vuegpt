<template>
    ...
    class="flex flex-col items-center justify-center w-full bg-amber-50 h-38 p-2 outline-0 rounded-3xl shadow-md shadow-gray-300 border-0 gap-2"
    >
    ...
    <div class="flex flex-row items-center justify-between w-full p-2">
        <div class="flex flex-row items-center  w-full gap-2">
            ...
            <!-- Search Button -->
            <button type="button" @click="sendMessage" class="flex items-center gap-1 bg-[#f1e8d6] hover:bg-white/50 text-gray-800 px-4 py-2 rounded-lg shadow border border-gray-200 transition-colors font-medium">
...
function sendMessage() {
    // Implement your send/search logic here
}
